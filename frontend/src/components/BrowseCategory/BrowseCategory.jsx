...
//         <path d="M9 6V2h6v4M9 18v4ph6v-4"></path>
...
//       </svg>
//     ),
//     isActive: true, // Preset active style option matching your image selection
//   },
//   {
//     id: 'headphones',
//     name: 'HeadPhones',
...
//       {/* Categories Card Track */}
//       <div className="categories-grid-layout">
//         {CATEGORIES.map((item) => (
//           <div 
//             key={item.id} 
//             className={`category-card-item ${item.isActive ? 'active-highlight' : ''}`}
//           >
